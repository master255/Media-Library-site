function DGPlayer(root) {
    ...
    // Preload images
    new Image().src = "/img/playbutton_active.png";
    new Image().src = "/img/pausebutton.png";
    new Image().src = "/img/pausebutton_active.png";
    new Image().src = "/img/choosefile_pressed.png";
    ...
    var seekBar = (function() {
        ...
        var loading = root.querySelector(".seek .track .loaded"),
            progress = root.querySelector(".seek .track .progress2"),
        ...
        function seekp(w) {
		if (player.player.asset.demuxer!=null) {if (player.player.asset.demuxer.seekPoints.length>0) {if (w.offsetX!=undefined) { player.player.seek (Math.round (trackLength *(((w.offsetX*100)/228)/100)));} else {player.player.seek (Math.round (trackLength *(((w.layerX*100)/228)/100)));}}}
		}
            loading.onmousedown= function (e) {seekp(e);}
			progress.onmousedown= function (e) {seekp(e);}
        function pad(input) {
    ...
    var slider = (function() {
        ...
        var handle = root.querySelector(".volume .handle"),
            progress = root.querySelector(".volume .progress2"),
